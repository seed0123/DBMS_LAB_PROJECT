...
<head>
    ...
    <div class="sub">
        ...
        <h1>Displaying Details of plane</h1>
    </div>
    <div class="refer">

        <a href="planesearch.html">Back</a>
    </div>
    ...
    <table class="table" align="center" border="1px" style="width:600px; line-height:30px;">
        <thead>
            ...
            <tbody>
                ...
                $check =  "select * from `airport`.`plane` where reg_no='$reg_no'";
                ...
                $sql1="SELECT * FROM `airport`.`plane` where reg_no='$reg_no'";
                $result1= $con->query($sql1);
                $sql2="SELECT * FROM `airport`.`model` ,`airport`.`plane` where plane.reg_no='$reg_no' && model.reg_no=plane.reg_no";
                $result2= $con->query($sql2);
                $sql3="SELECT * FROM `airport`.`test_info` ,`airport`.`plane` where plane.reg_no='$reg_no' && plane.reg_no=test_info.reg_no";
