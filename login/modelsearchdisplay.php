...
<head>
    ...
    <div class="refer">
        ...
        <a href="modelsearch.html">Back</a>
    </div>
    ...
    <table class="table" align="center" border="1px" style="width:600px; line-height:30px;">
        <thead>
            ...
            <tbody>
                ...
                $check =  "select * from `airport`.`model` where model_no='$model_no'";
                ...
                $sql1="SELECT * FROM `airport`.`model` where model_no='$model_no'";
                $result1= $con->query($sql1);
                $sql2="SELECT * FROM `airport`.`model_tech` where model_no='$model_no'";
